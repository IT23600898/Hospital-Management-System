...
<head>
  ...
  <title>HospitaLink | Edit Appointment</title>
...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <!-- Full Width Form -->
      <form action="${pageContext.request.contextPath}/appointment" method="POST" onsubmit="return validateMedicineForm()" class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full">
  ...
  function validateForm() {
    ...
    const appointmentDateTime = new Date(appointmentInput.value);
    const now = new Date();
    ...
    // Extract hour from the selected datetime
    const hour = appointmentDateTime.getHours();
    const minutes = appointmentDateTime.getMinutes();

    // Check if time is between 08:00 (8AM) and 20:00 (8PM)
    if (hour < 8 || (hour === 20 && minutes > 0) || hour > 20) {
